...
class Huffman:
    ...
    def createCompressText(self) -> None:
        """
        ...
        with open("books/world_leaders.txt", "r", encoding="utf-8") as text:
        ...
        with open("output/world_leaders.bin", "wb") as newFile:
            binary_string.tofile(newFile)
        newFile.close()

    def createDecompressText(self, root) -> None:
        """
        ...
        with open("output/world_leaders.bin", "rb") as compressedText:
        ...
        with open("output/world_leaders.txt", "w", encoding="utf-8") as decompressedText:
